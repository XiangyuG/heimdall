...
int trace_done(struct request *rq)
{
	...
	int __vanilla_benchmark_duration_1_condition_9 = !!(((unsigned long)rq & (1UL << 8)) != 0);
	__u64 __vanilla_benchmark_duration_1_value_9 = __vanilla_benchmark_duration_1_condition_9 ? ((__vanilla_benchmark_duration_1_value_8) + (256)) : __vanilla_benchmark_duration_1_value_8;
	int __vanilla_benchmark_duration_1_condition_10 = !!(((unsigned long)rq & (1UL << 9)) != 0);
	__u64 __vanilla_benchmark_duration_1_value_10 = __vanilla_benchmark_duration_1_condition_10 ? ((__vanilla_benchmark_duration_1_value_9) + (512)) : __vanilla_benchmark_duration_1_value_9;
	benchmark_duration = __vanilla_benchmark_duration_1_value_10;
