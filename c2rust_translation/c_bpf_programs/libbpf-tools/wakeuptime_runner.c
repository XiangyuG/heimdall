...
int main(int argc, char **argv)
{
	...
	if (argc != 3) {
		fprintf(stderr, "usage: %s WAKEUPTIME.o SECONDS\n", argv[0]);
		return 2;
	}
	...
	printf("Generate a consistent scheduler workload in another terminal.\n");
	printf("Example: stress-ng --sem 8 --timeout %ds\n", seconds);
	fflush(stdout);
